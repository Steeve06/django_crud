...
from django.contrib import messages  # flash a msg after login or logout
...
def home(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'home.html', {'records': records})  # points to the html of the home page
